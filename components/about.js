        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-4 leading-7">
              ...
              <p>
                ჩვენ ვამაყობთ იმით, რომ ვართ გამოსავალი მათთვის, ვისაც
                ესაჭიროება სასწრაფო დახმარება და სიმშვიდე სტრესულ სიტუაციებში.
                თქვენი მანქანის უსაფრთხოება ჩვენი მთავარი პრიორიტეტია.
              </p>
              <p>
                ჩვენ ვიყენებთ უახლეს აღჭურვილობას და ტექნიკას უსაფრთხო
                დატვირთვის, ტრანსპორტირებისა და გადმოტვირთვის უზრუნველსაყოფად.
              </p>
            </div>
          </div>
